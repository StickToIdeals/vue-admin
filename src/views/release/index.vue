    ...
    <el-form :inline="true"
      ...
      <el-form-item label="版本文件"
        ...
        <el-upload class="upload-demo"
                   drag
                   action="customize"
                   :http-request="molyUploadSectionFile"
          ...
          <div class="el-upload__tip"
               slot="tip">只能上传ZIP,APK文件，且不超过1000MB</div>
        </el-upload>
      </el-form-item>
      <el-form-item label="版本类型"
                    style="width:30%"
                    prop="version_type">
        <el-select v-model="form.version_type"
                   placeholder="请选择版本类型">
          <el-option label="安卓"
                     value="1"></el-option>
      ...
      <el-form-item label="版本号"
                    style="width:30%"
                    prop="version_num">
        <el-input-number v-model="form.version_num"
                         :precision="1"
                         :step="0.1"
                         :max="50"
                         style="width:195px"></el-input-number>
      </el-form-item>
      <el-form-item label="文件签名"
                    style="width:30%"
                    prop="version_sign">
        <el-input v-model="form.version_sign"
                  style="width:195px"></el-input>
      </el-form-item>
      <el-form-item label="请求地址"
                    style="width:30%"
                    prop="version_url">
        <el-input v-model="form.version_url"
                  style="width:195px"></el-input>
      </el-form-item>
      <el-form-item label="发布环境"
                    style="width:30%"
                    prop="version_env">
        <el-select v-model="form.version_env"
                   placeholder="请选择发布环境">
      ...
      <el-form-item label="发布渠道"
                    style="width:30%"
                    prop="version_channel">
        <el-select v-model="form.version_channel"
                   placeholder="请选择发布渠道">
          <el-option label="全渠道"
                     value="1"></el-option>
      ...
      <el-form-item label="是否强制更新"
                    style="width:30%"
                    prop="update_must">
        <el-select v-model="form.update_must"
      ...
      <el-form-item label="是否全量更新"
                    style="width:30%"
                    prop="update_all_or_half">
        <el-select v-model="form.update_all_or_half"
                   placeholder="请选择是否全量更新">
          <el-option label="全量更新"
                     value="1"></el-option>
          <el-option label="增量更新"
                     value="2"></el-option>
        </el-select>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    molyUploadSectionFile (param) {
      costools.sliceUploadFile(
        costools.getConfig()
        , 'release-files', param.file, (progress) => {
