  ...
  <div class="app-container">
    ...
    <el-form :inline="true" :model="queryFormData" class="demo-form-inline">
      <el-form-item label="版本类型">
        <el-select v-model="queryFormData.version_type" placeholder="请选择版本类型">
          <el-option label="安卓" value="1"></el-option>
          <el-option label="公共文件" value="2"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="版本号">
        <el-input-number v-model="queryFormData.version_num" :precision="1" :step="0.1" :max="50"></el-input-number>
      </el-form-item>
      <el-form-item label="发布环境">
        <el-select v-model="queryFormData.env" placeholder="请选择发布环境">
          <el-option label="SIT环境" value="1"></el-option>
          <el-option label="UAT环境" value="2"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="发布渠道">
        <el-select v-model="queryFormData.channel" placeholder="请选择发布渠道">
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button type="text" size="small" @click="handleDownClick(scope.row)">下载</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!--二维码显示组件-->
    <el-dialog title="请扫描二维码下载" center :visible.sync="dialogShowQRCode" width="260px" @opened="showQRCode()">
      <div class="qrcode">
        <div id="qrcode"> </div>
      </div>
    </el-dialog>
